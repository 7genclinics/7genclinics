...
export function LandingHeader({ overlay = false }: LandingHeaderProps) {
  ...
  return (
    ...
    >
      <div className="relative mx-auto flex h-[4.5rem] max-w-6xl items-center justify-between px-4 sm:px-6">
      ...
      >
        ...
        <div
          className={cn(
            "absolute inset-x-0 top-[4.5rem] max-h-[calc(100dvh-4.5rem)] overflow-y-auto border-b border-brand-100 bg-white transition-all duration-200",
