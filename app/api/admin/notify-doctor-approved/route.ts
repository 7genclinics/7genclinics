      ...
      ? `
        <div style="font-family:sans-serif;max-width:560px;margin:auto;padding:32px 24px;background:#fff;border-radius:12px;border:1px solid #e2e8f0">
          ...
          <p style="color:#475569;line-height:1.6">
            Your doctor profile on <strong>Apna Clinic</strong> has been reviewed and <strong style="color:#16a34a">approved</strong>.
          ...
          <p style="color:#94a3b8;font-size:12px;margin-top:32px">Apna Clinic · Pakistan Telehealth Platform</p>
        </div>`
      : `
        <div style="font-family:sans-serif;max-width:560px;margin:auto;padding:32px 24px;background:#fff;border-radius:12px;border:1px solid #e2e8f0">
          <h2 style="color:#0f172a;margin-bottom:8px">Application Update — ${doctorName}</h2>
          <p style="color:#475569;line-height:1.6">
            After review, your doctor application on <strong>Apna Clinic</strong> was <strong style="color:#dc2626">not approved</strong>.
          </p>
